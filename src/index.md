...
- 瀑布流性能优化：主导首页商品瀑布流重构，采用虚拟列表 + 图片按需加载 + 差异化渲染策略。FPS 从 45 提升至满帧 58，滚动卡顿率降低 70%，首屏渲染耗时从 1200ms 锐减至 400ms。
- 动态表单架构：独立负责“求购发布”核心链路，基于 FormBuilder 实现 10+ 字段的条件联动渲染与复杂正则校验，日均稳定支撑 5000+ 次求购发布。
